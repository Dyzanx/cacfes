<nav x-data="{ open: false }" class="bg-gray-700 border-b border-gray-400">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-jet-nav-link href="{{ route('tallas') }}" :active="request()->routeIs('tallas')">
                        {{ __('Tallas') }}
                    </x-jet-nav-link>
                    @endif
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-jet-responsive-nav-link href="{{ route('facturaCostos') }}"
                :active="request()->routeIs('facturaCostos')">
                {{ __('Costos') }}
            </x-jet-responsive-nav-link>
            ...
            <x-jet-responsive-nav-link href="{{ route('tallas') }}" :active="request()->routeIs('tallas')">
                {{ __('Tallas') }}
            </x-jet-responsive-nav-link>
            @endif

                    ...
                    <div class="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8">
                        <div class="shadow overflow-hidden sm:rounded-lg">
                            ...
                            <h1 class="font-bold text-black p-3 text-2xl sm:text-3xl border-b-2 border-black">Editar
                                talla -
                                <span class="uppercase">{{$tallaEdit->nombre}}</span>
                            </h1>
                            @else
                            <h1 class="font-bold text-black p-3 text-2xl sm:text-3xl border-b-2 border-black">Agregar
                                nueva talla</h1>
                            @endif
                                    ...
                                    <div class="px-4 py-5 bg-gray-100 sm:p-6">
                                        <div class="grid grid-cols-6 gap-6">
                                            <div class="col-span-6 sm:col-span-3">
                                                ...
                                                <input type="text" wire:model="nombre" value="{{$tallaEdit->nombre}}"
                                                    autofocus placeholder="{{$tallaEdit->nombre}}" name="nombre"
                            ...
                            <table class="min-w-full divide-y divide-black border-t-2 border-black">
                                ...
                                <tbody class="bg-gray-200 text-center">
                                    <tr class="border-2 border-gray-900">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap border-r-2 border-gray-900">
                                            <a href="" wire:click.prevent="eliminar({{$ta->id}})"><i
...
<head>
    <title>{{ config('app.name') }} - Tallas</title>
</head>
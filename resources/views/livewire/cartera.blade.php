                    ...
                    <div class="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8">
                        <div class="shadow overflow-hidden sm:rounded-lg">
                            ...
                            <h1 class="font-bold text-black p-3 text-xl sm:text-3xl border-b-2 border-black">Editar
                                elemento - #{{$carteraEdit->id}}</h1>
                            @else
                            <h1 class="font-bold text-black p-3 text-xl sm:text-3xl border-b-2 border-black">Añadir
                                elemento a la
                                cartera</h1>
                            @endif
                            ...
                            @else
                            <i wire:click.prevent="crear()" title="Agregar un elemento"

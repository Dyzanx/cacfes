        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="-my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
                ...
                <div class="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
                    @if($crear == 'true' || $ventaEdit != '')
                        @if($ventaEdit != '')
                        <h1 class="font-bold text-black p-3 text-3xl">Editar Venta - #</h1>
                        @elseif($crearPago != 'false')
                        <h1 class="font-bold text-black p-3 text-3xl">Añadir Nuevo Pago</h1>
                        @else
                        <h1 class="font-bold text-black p-3 text-3xl">Añadir Nueva Venta</h1>
                        @endif
                        <form>  
                        ...
                        <div class="shadow overflow-hidden sm:rounded-md">
                            <div class="px-4 py-5 bg-white sm:p-6">
                                ...
                                <div class="col-span-6 sm:col-span-3">
                                    ...
                                    <div class="col-span-6 sm:col-span-3">
                                        <label for="facturaPago" class="block text-sm font-medium text-gray-700">Factura<span class="text-red-400 font-bold"> *</span></label>
                                        <input type="text" wire:model="facturaPago" name="factura" autocomplete="off" class="mt-1 focus:ring-green-400 focus:border-green-400 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                    </div>
                                    ...
                                    <div class="col-span-12 sm:col-span-12">
                                        <label for="saldo" class="block text-sm font-medium text-gray-700">Observación</label>
                                        <textarea wire:model="observacion" name="observacion" cols="30" rows="10" class="mt-1 focus:ring-green-400 focus:border-green-400 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"></textarea>
                                    </div>
                            ...
                            <div class="px-4 py-3 bg-gray-50 text-right sm:px-6">
                                ...
                                <button wire:click.prevent="savePago()" type="submit" class="inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-green-400 hover:bg-green-400 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-400">
                                    Añadir
                                </button>
                            </div>
                        </div>
                    </form>
                    @elseif($crearOb != 'false')
                    <h1 class="font-bold text-black p-3 text-3xl">Añadir Nueva Nota</h1>
                        <hr>
                        <form>  
                        <div class="shadow overflow-hidden sm:rounded-md">
                            <div class="px-4 py-5 bg-white sm:p-6">
                                <div class="grid grid-cols-11 gap-6">
                                    ...
                                    <div class="col-span-12 sm:col-span-8">
                                        <label for="notaOb" class="block text-sm font-medium text-gray-700">Observación<span class="text-red-400 font-bold"> *</span></label>
                                        <textarea wire:model="notaOb" name="notaOb" cols="30" rows="3" class="mt-1 focus:ring-green-400 focus:border-green-400 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"></textarea>
                                    </div>
                            ...
                            <div class="px-4 py-3 bg-gray-50 text-right sm:px-6">
                                ...
                                <button wire:click.prevent="saveOb()" type="submit" class="inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-green-400 hover:bg-green-400 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-400">
                                    Añadir
                                </button>
                            </div>
                        </div>
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <a href="">
                                <i wire:click.prevent="crearPago()" class="bi bi-cash bg-green-400 hover:bg-green-300 rounded text-lg text-white p-3"></i>
                            </a>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                            <a href="" wire:click.prevent="crearOb({{$venta->factura}})">

                        ...
                        <div class="-my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
                            <div class="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8">
                                <div class="shadow overflow-hidden sm:rounded-lg font-bold">
                                    ...
                                    <h1 class="font-bold text-black p-3 text-3xl border-b-2 border-black">Detalles de la factura :
                                        {{$ventaDetalle->factura}}</h1>
                                    @elseif($obDetalle)
                                    <h1 class="font-bold text-black p-3 text-3xl border-b-2 border-black">Observación de la factura :
                                        {{$obDetalle->factura}}</h1>
                                    @endif
                                    @if($ventaDetalle && $pagoDetalle && $obDetalle)
                                    <ul class="p-5">
                                    ...
                                    @elseif($obDetalle)
                                    <form class="p-6">
                                        <textarea wire:model="notaDetalle" name="notaOb" cols="30" rows="6"
                                            placeholder="{{$obDetalle->nota}}" value="{{$obDetalle->nota}}" autofocus 
                                        ...
                                        <div class="px-4 py-3 text-right sm:px-6">
                                            <a href="" wire:click.prevent="cancelarDetalles()"
                                                ...
                                                Cancelar</a>
                                            <button wire:click.prevent="saveDetalleNota('{{$obDetalle->factura}}')"
                                                type="submit"
                    ...
                    <div class="-my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
                        <div class="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8">
                            <div class="shadow overflow-hidden sm:rounded-lg">
                                ...
                                @elseif($ventaEdit != '')
                                <h1 class="font-bold text-black p-3 text-3xl border-b-2 border-black">Editar Venta - </h1>
                                @endif
                                <hr>
                                <form>
                                        ...
                                        <div class="px-4 py-5 bg-blue-300 sm:p-6">
                                            <div class="grid grid-cols-12 gap-6">
                                                ...
                                                <div class="col-span-6 sm:col-span-3">
                                                    ...
                                                    <input type="date" wire:model="fecha" name="fecha"
                                                        autocomplete="off"
                            ...
                            <table class="min-w-full divide-y divide-gray-200">
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    <tr class="text-center bg-pink-300 border-2 border-pink-400">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap border-r-2 border-pink-400">
                                                <i wire:click.prevent="editar('{{$venta->factura}}')" class="cursor-pointer bi bi-pen bg-blue-500 hover:bg-blue-400 rounded text-lg text-white p-3"></i>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap border-r-2 border-pink-400">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap border-r-2 border-pink-400">
                                            <a href="">
                                                <i wire:click.prevent="detallesNota('{{$venta->factura}}')"
                                                    class="bi bi-card-checklist bg-yellow-400 hover:bg-yellow-200 rounded text-lg text-white p-3"></i>
                                            </a>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap border-r-2 border-pink-400">

                ...
                <div class="-my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
                    <div class="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8">
                        <div class="shadow overflow-hidden sm:rounded-lg">
                            ...
                            @if($tipoCostoEdit != '')
                            <h1 class="font-bold text-black p-3 text-2xl sm:text-3xl border-b-2 border-black">Editar Tipo De Costo -
                                #{{$tipoCostoEdit->id}}</h1>
                            @else
                            <h1 class="font-bold text-black p-3 text-2xl sm:text-3xl border-b-2 border-black">Añadir Nuevo Tipo De
                                Costo</h1>
                            @endif

                            <form @if($tipoCostoEdit) wire:submit.prevent="update({{$tipoCostoEdit->id}})" @else
                                        ...
                                        <div class="grid grid-cols-6 gap-6">
                                            <div class="col-span-6 sm:col-span-3">
                                                ...
                                                <input type="text" wire:model="nombre"
                                                    ...
                                                    placeholder="{{$tipoCostoEdit->nombre}}" name="nombre" id="nombre" autocomplete="off"
                            ...
                            <table class="min-w-full divide-y divide-gray-200">
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    <tr class="text-center bg-pink-300 border-2 border-pink-400">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap border-r-2 border-pink-400">
                                            <a href="" wire:click.prevent="borrar({{$tipo->id}})"><i

        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-gray-100 rounded-lg overflow-hidden shadow-xl sm:rounded-lg">
                <div class="flex flex-col">
                    <div class="-my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
                        <div class="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8">
                            <div class="shadow overflow-hidden border-b border-gray-200 rounded-lg sm:rounded-lg pb-4">
                                <i wire:click.prevent="cancelarCoste()" title="cerrar esta ventana"
                                    class="bi bi-x m-3 cursor-pointer float-right inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-lg font-medium rounded-md text-white bg-red-400 hover:bg-red-500 focus:outline-none focus:ring-2 focus:ring-red-400"></i>
                                <h1 class="font-bold text-black p-3 text-2xl sm:text-3xl border-b-2 border-black">Coste
                                    de la categoria :
                                    @foreach($categorias as $cat) @if($cat->id == $costeCatId) {{$cat->nombre}} @endif
                                    @endforeach</h1>
                                <table class="min-w-full divide-y divide-black border-t-2 border-black">
                                    ...
                                    <tbody class="bg-gray-200 text-center">
                                        <tr class="border-2 border-gray-900">
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap border-r-2 border-gray-900">
                                                {{number_format($co->precio*$co->cantidad)}}
                                            </td>
                                        </tr>
                                    </tbody>
                                    @endforeach
                ...
                <div class="-my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
                    <div class="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8">
                        <div class="shadow overflow-hidden sm:rounded-lg">
                            ...
                            @else
                            <i wire:click.prevent="crear()" title="agregar nuevo elemento"
                            ...
                            <table class="min-w-full divide-y divide-black border-t-2 border-black">
                                ...
                                <tbody class="bg-gray-200 text-center">
                                    <tr class="border-2 border-gray-900">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap border-r-2 border-gray-900">
                                            <a href="" wire:click.prevent="eliminar({{$cat->id}})"><i
...
<head>
    <title>{{ config('app.name') }} - Categorias</title>
</head>
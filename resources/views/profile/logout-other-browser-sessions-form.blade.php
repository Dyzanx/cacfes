    ...
    <x-slot name="content">
        <div class="max-w-xl text-sm text-gray-900">
            {{ __('Si es necesario, puede cerrar la sesión de todas las demás
             ...
             puede no ser exhaustiva. Si cree que su cuenta se ha visto comprometida,
